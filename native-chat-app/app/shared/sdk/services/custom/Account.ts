...
export class AccountApi extends BaseLoopBackApi {
  ...
  public findByIdAccessTokens(id: any, fk: any) {
    ...
    return result.map((result: Account | Array<Account>) => Array.isArray(result)
                             ? result.map((instance: Account)=> new Account(instance))
                             : new Account(result));
  }
   ...
   * </em>
   */
  public getRoomAccounts(id: any, filter: LoopBackFilter = undefined) {
    let method: string = "GET";
